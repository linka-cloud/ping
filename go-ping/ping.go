...
// Statistics represent the stats of a currently isRunning or finished
// pinger operation.
...
// Privileged returns whether pinger is isRunning in privileged mode.
...
// pinger is isRunning or after it is finished. OnFinish calls this function to
